...
presence.on("UpdateData", async () => {
    ...
    if (document.location.pathname == "/") {
        ...
        title = document.querySelector("#prog_name");
        ...
        title = document.querySelector("#navsearchform > input.navsearchinput");
        ...
        title = document.querySelector("#page_content_parent > div.mainheadmiddle");
        presenceData.state = title.innerText;
    }
